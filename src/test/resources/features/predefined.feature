...
#    Then element with xpath "//*[@id='res']" should contain text "Cucumber"
  ...
  Scenario: Quiz - Total questions
    ...
    Then I wait for 3 sec
    Then element with xpath "//*[contains(text(),'Vlasov Teacher-2')]" should be displayed
    Then I click on element with xpath "//*[contains(text(),'Quizzes')]"
    Then I wait for 3 sec
    Then I click on element with xpath "//*[contains(text(),'Create New Quiz')]"
    Then I wait for 2 sec
    Then I type "Quiz" into element with xpath "//*[@formcontrolname='name']"
    Then I wait for 2 sec
    Then I click on element with xpath "//mat-icon[contains(text(),'add_circle')]"
    Then I click on element with xpath "//mat-radio-button[@id='mat-radio-3']"
    Then I wait for 2 sec
    Then I type "Question" into element with xpath "//*[@placeholder='Question *']"
    Then I type "Answer 1" into element with xpath "//*[@placeholder='Option 1*']"
    Then I type "Answer 2" into element with xpath "//*[@placeholder='Option 2*']"
    Then I click on element with xpath "//*[@id='mat-radio-8']/label/div[1]/div[1]"
...
#    Then I type "Evgenii" into element with xpath "//input[@placeholder='First Name']"
#    Then I type "Vlasov" into element with xpath "//input[@placeholder='Last Name']"
#    Then I type "vlasovfake1@gamail.com" into element with xpath "//input[@placeholder='Email']"
...
#    Then I confirm user account with email "vlasovfake1@gamail.com"
#    Then I wait for 3 sec
#    Then I take screenshot
#    Then I open url "http://ask-stage.portnov.com"
#    Then I type "vlasovfake@gamail.com" into element with xpath "//*[@formcontrolname='email']"
#    Then I type "12345Abc" into element with xpath "//*[@formcontrolname='password']"
#    And I click on element with xpath "//button[@type='submit']"
#    Then I wait for 3 sec
